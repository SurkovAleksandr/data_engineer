create database taxi location 's3a://karpov-al-surkov-bucket/';
...
lines terminated by '\n'
location 's3a://karpov-al-surkov-bucket/yellow-taxi/2020'
...
fields terminated by ','
lines terminated by '\n'
location 's3a://karpov-al-surkov-bucket/2020';
...
stored as orc
location 's3a://karpov-al-surkov-bucket/warehouse/trips_part';
